...
class test_barcos(TestCase):
    ...
    def test_barco_dinamico_especial(self):
    ...
    def test_barco_dinamico_basico(self):
        ...
        # Crea dinamicamente un barco del tipo que se le pase por parametro, en este caso "Basico"