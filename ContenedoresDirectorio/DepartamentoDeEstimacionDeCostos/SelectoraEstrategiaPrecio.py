...
class SelectoraEstrategiaPrecio():
    ...
    '''def estrategia_por_categoria(self, distancia):
        estrategias = {
            OpcionesDistancia.MENOR100.value: distancia < 100,
            OpcionesDistancia.MENOR1000.value: distancia < 1000,
            OpcionesDistancia.MENOR10000.value: distancia < 10000,
    ...
    '''
    #Versión que llega a raisear la exception
    def estrategia_por_categoria(self, distancia):
        estrategias = {
